        ...
        (a.shortnameToAscii = function (b) {
            ...
            return (b = b.replace(a.regShortNames, function (b) {
                return "undefined" != typeof b && "" !== b && b in a.emojioneList
                    ? ((c = a.emojioneList[b].unicode[a.emojioneList[b].unicode.length - 1]),
            ...
            return (
                ...
                a.ascii &&
                    (b = b.replace(a.regAscii, function (b, d, e, f) {
                        return "undefined" != typeof f && "" !== f && a.unescapeHTML(f) in a.asciiList
                            ? ((f = a.unescapeHTML(f)), (c = a.asciiList[f].toUpperCase()), e + a.convert(c))
                            : b;
                    })),
                b
            );
